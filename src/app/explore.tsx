...
export default function Explore() {
  ...
  useEffect(() => {
    const animation = Animated.timing(searchResultsAnim, {
      ...
      duration: isSearching ? 300 : 200,
      useNativeDriver: true,
      easing: isSearching ? Easing.out(Easing.cubic) : Easing.in(Easing.cubic),
    });
            ...
            {showAirportList ? (
              ...
              <View style={{ flex: 1 }}>
                ...
                >
                  <View style={styles.headerSection}>
                    ...
                    <Animated.View 
                      style={[
                        ...
                        {
                          transform: [{
                            translateY: eventsHeaderAnim.interpolate({
                              inputRange: [0, 1],
                              outputRange: [-20, 0]
                            })
                          }]
                  ...
                  <View style={styles.usersListContent}>
